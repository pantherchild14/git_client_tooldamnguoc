                ...
                <table width="100%" border="0" align="center" cellPadding="2" cellSpacing="1">
                    ...
                    <tbody>
                        {sortedOdds.map((data, index) => {
                            const instantDraw = data?.$?.['INSTANT_DRAW'];
                            const prevInstantDraw = index > 0 ? parseFloat(sortedOdds[index + 1]?.$['INSTANT_DRAW']) : null;
                            ...
                            const drawTextColor = prevInstantDraw !== null && instantDraw !== null
                                ? instantDraw > prevInstantDraw ? 'red' : instantDraw < prevInstantDraw ? 'green' : ''
                                : '';
                            ...
                            return (
                                <tr key={index} style={{ textAlign: 'center' }}>
                                    ...
                                    <td width="16%" style={style.border}><span style={{ color: drawTextColor }}>{instantDraw}</span></td>
