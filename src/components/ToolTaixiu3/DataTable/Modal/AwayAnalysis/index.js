                    ...
                    <thead>
                        <tr>
                            <th width="100%" height="20" colSpan="7" className="hand-bg" align="center" style={styles.title}>
                                <font color="white"><b>Away</b></font>
                            </th>
                        </tr>
                            ...
                            return (
                                <React.Fragment key={index}>
                                    <tr key={index} name={`oddsTr_${index + 1}`} className="tb-bgcolor1" cid="8" style={{ textAlign: 'center' }}>
                                        ...
                                        <td width="10%" height="30" style={{ color: away(dataArray[4]), padding: '5px', border: '1px solid #ccc', border: '1px solid #ccc' }}>{dataArray[4]}</td>
                                        ...
                                        <td width="10%" height="30" style={{ color: away(dataArray[6]), padding: '5px', border: '1px solid #ccc', border: '1px solid #ccc' }}>{dataArray[6]}</td>
