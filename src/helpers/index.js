...
export const checkAndClearLocalStorage = () => {
    ...
    if (lastLoginTime) {
        ...
        if (currentTime - parseInt(lastLoginTime, 10) > oneDayInMillis) {
            // More than one day has passed, clear localStorage items
            clearLocalStorage();
            localStorage.setItem('lastLoginTime', currentTime.toString());
        }
    } else {
        // Set lastLoginTime if it doesn't exist
...
export const UTCtoLocalTime = (utcTimestamp, timeZoneOffset) => {
...
export const UTCtoLocalTimeTool1 = (utcTimestamp, timeZoneOffset) => {
